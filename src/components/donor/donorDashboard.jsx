...
const DonorDashboard = () => {
  ...
  const placeholderRequests = [
    { id: 'req1', recipientName: 'edgah mwasiage', status: 'pending', recipientId: 'recipient1' },
    { id: 'req2', recipientName: 'Benedict Kenyan', status: 'pending', recipientId: 'recipient2' },
  ];

  const placeholderDonations = [
    { id: '2dfe4523edc', foodtype: 'Fruits', quantity: 10, expierydate: '2024-12-31', status: 'available' },
    { id: 'sdw434fdfg5', foodtype: 'Vegetables', quantity: 5, expierydate: '2024-12-25', status: 'available' },
  ];
